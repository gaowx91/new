<template>
    <div class="wrapper">
        <v-Header>
            <div class="mod-header mod-header-detail" slot="detail-header" id="mod-header">
                ...
                <mt-navbar class="tab-navbar title" v-model="selected">
                    <router-link to="goodsDetail" class="is-selected">商品</router-link>
                    <router-link to="goodsdetailrate">評價</router-link>
                    <router-link to="goodsdetailqalist">問與答</router-link>
                </mt-navbar>
                <!--         <router-link to="">商品</router-link>
                <router-link to="">評價</router-link>
                <router-link to="">問與答</router-link> -->
                <span class="is-right">
        ...
        <v-Content>
            ...
            <!-- <v-BigImg v-if="isImgViewsShow" @clickit="eImgViewClick" :defaultIndex="isIndex" :imageData="swipe"></v-BigImg> -->
            ...
            <v-CellBox padded>
                <div class="s-prop">
                    <!-- <div class="hd" @click="popupVisible4 = true">
                        <span class="tit">帳號屬性</span>
            ...
            <v-CellBox padded>
                <div class="s-bonus">
                    <!-- <div class="hd">
                        <span class="tit">
                        <img src="static/images/common/redbonus.png" alt="">購買可獲得紅利<span class="text-danger fz30 mh5">6666</span>點</span>
                        <i class="mint-cell-allow-right">我的紅利</i>
                    </div> -->
...
<script>
import '#/css/goods/goods_detail.css'
